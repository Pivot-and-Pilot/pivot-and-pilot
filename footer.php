...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<a href="mailto:hello@pivotandpilot.com"><button class="align-center alternate">Let's Grab A Coffee</button></a>
		<address>
		...
		<div class="site-info">
			<p class="align-center-text">2017 &copy; Pivot & Pilot Inc.</p>
		</div><!-- .site-info -->
		</path>
	</footer><!-- #colophon -->
</div><!-- #page -->
